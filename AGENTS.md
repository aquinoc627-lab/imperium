...
- The roadmap through Phase 13 is complete. Phase 14 (`specs/14-mcp.md`, MCP tool surface) is confirmed and in progress. New work beyond it requires a new named spec confirmed by the owner first.
