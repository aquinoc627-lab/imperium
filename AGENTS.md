...
- Allowed product: through Phase 24 (complete) — see `specs/STATUS.md`. Specs `07`–`24` and `specs/v0-slice.md` describe what shipped. Specs `02`–`04` are deferred depth; do not implement them.
