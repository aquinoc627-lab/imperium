...
- The roadmap through Phase 17 is complete (policy impact analysis & coverage). Phase 18 (`specs/18-secret-binding.md`, OS keychain secret binding) is confirmed and in progress. New work beyond it requires a new named spec confirmed by the owner first.
