...
- Allowed product: through Phase 22 (complete) — see `specs/STATUS.md`. Specs `07`–`22` and `specs/v0-slice.md` describe what shipped. Specs `02`–`04` are deferred depth; do not implement them.
