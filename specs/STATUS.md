...
Phases 19–23 shipped (voice input-only; MC factor breadth; host-layer
hardening; release & distribution; MCP packaging). Specs `02`–`04` retain
...
SLSA Levels 2–4 and sigstore signing remain deferred even after Phase 22
(provenance is emitted, not signed).
